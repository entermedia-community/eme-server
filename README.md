...
1. Fork server to make your changes
    ...
    ##baseupgrade To latest release version
    git fetch upstream
    ...
    ##branchcommit changes with push to origin
    git add -A .
    git commit -m "My changes in My server"
    git push

    ```

4. use eme script to streamline
    ```
    ##If you want to push to eme-server make a branch and commit the changes in there
